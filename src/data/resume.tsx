  ...
  work: [
    {
      ...
      description:
        "Architected a config-driven UI system for shared web/mobile frameworks, enabling new AI models to ship with zero UI code changes. Built an internal npm package of 15+ pure functions across leading AI models for composable agent orchestration. Designed a Trigger.dev + Inngest hybrid job orchestration fallback architecture, ensuring resilient audio processing workloads under provider failures.",
    },
    {
      company: "DevDotCom",
